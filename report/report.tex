...
\end{equation}
over $S$ posterior draws, and likewise for $\RAT$. Because this is an average it carries
...
\noindent
Thus $\RAC(t)=\RAT(t)=1-e^{-H_{\mathrm{inf}}(t)}$. The \cori{} row is included as the Poisson
