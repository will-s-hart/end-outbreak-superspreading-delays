...
\begin{figure}[htbp]
  ...
  \caption{\textbf{The gap between the risk of additional cases and the risk of additional
    ...
    $\RAC$. Solid: $\RAT$. The shaded region is generated by the incubation-pipeline term
    $M(t)$ in Proposition~\ref{prop:onset}: individuals already infected on the conditioning day
    but not yet symptomatic. Under the three infection-anchored models these two curves coincide
    by assumption.}
  \label{fig:rat}
\end{figure}
